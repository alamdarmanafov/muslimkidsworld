...
export const quizBank: QuizQuestion[] = [
  ...
  },
  {
    ...
    category: "din",
    options: [
      { id: "a", label: "A", emoji: "", textKey: "content.quizSymbols.moon" },
      { id: "b", label: "B", emoji: "", textKey: "content.quizSymbols.star" },
      { id: "c", label: "C", emoji: "", textKey: "content.quizSymbols.sun" },
  ...
  },
  {
    ...
    category: "din",
    options: [
      { id: "a", label: "A", emoji: "", text: "60" },
      { id: "b", label: "B", emoji: "", text: "63" },
      { id: "c", label: "C", emoji: "", text: "65" },
      { id: "d", label: "D", emoji: "", text: "70" },
    ],
    correctOptionId: "b",
    xp: 20,
  },
  ...
  },
  {
    ...
    category: "elm",
    options: [
      { id: "a", label: "A", emoji: "", text: "200" },
      { id: "b", label: "B", emoji: "", text: "206" },
      { id: "c", label: "C", emoji: "", text: "210" },
      { id: "d", label: "D", emoji: "", text: "220" },
    ],
    correctOptionId: "b",
    xp: 20,
  },
  ...
  },
  {
    ...
    category: "elm",
    options: [
      { id: "a", label: "A", emoji: "", text: "50" },
      { id: "b", label: "B", emoji: "", text: "60" },
      { id: "c", label: "C", emoji: "", text: "70" },
      { id: "d", label: "D", emoji: "", text: "80" },
    ],
    correctOptionId: "b",
    xp: 20,
  },
