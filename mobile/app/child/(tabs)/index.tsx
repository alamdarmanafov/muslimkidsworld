...
const grid = [
  { label: "Learn", emoji: "📖", tone: tones.teal, href: "/child/learn" as const },
  { label: "World", emoji: "🌍", tone: tones.blue, href: "/child/world" as const },
  { label: "Good Deeds", emoji: "❤️", tone: tones.pink, href: "/child/rewards" as const },
  { label: "Rewards", emoji: "🎁", tone: tones.gold, href: "/child/rewards" as const },
  { label: "Events", emoji: "🎉", tone: tones.orange, href: "/child/world" as const },
  { label: "Profile", emoji: "😊", tone: tones.yellow, href: "/child/profile" as const },
];
    ...
    <SafeAreaView style={styles.screen} edges={["top"]}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Card style={styles.statsRow}>
          <StatPill emoji="⭐" tone={tones.gold} label="Level" value={activeChild.level} />
          <StatPill emoji="🏆" tone={tones.orange} label="XP" value={activeChild.xp} />
          <StatPill emoji="🔥" tone={tones.red} label="Streak" value={activeChild.streak} />
        </Card>

        <Card style={styles.missionCard}>
          <Text style={styles.missionLabel}>Today's Mission</Text>
          <View style={styles.missionRow}>
            <IconBadge emoji="🧠" tone={tones.purple} size={56} />
            <View style={{ flex: 1 }}>
          ...
          {grid.map((item) => (
            ...
            >
              <Card style={styles.gridCard}>
                <IconBadge emoji={item.emoji} tone={item.tone} size={44} />
